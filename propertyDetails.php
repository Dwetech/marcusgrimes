            ...
            <div class="col-md-4 noPadding">
                <div class="side-bar">
                    <div class="col-md-12 normal-padding">
                        ...
                        <div class="details-content-section">
                            <ul class="icon-absolute">
                                <li class="popup popover-bath" data-toggle="popover" data-content="Lorem Ipsum"><img
                                        class="" src="img/bath.png" alt=""/> <span>x 3</span></li>
                                <li class="popup popover-bed" data-toggle="popover" data-content="Lorem Ipsum"><img
                                        class="" src="img/bed.png" alt=""/> <span>x 5</span></li>
                                <li class="popup popover-living" data-toggle="popover" data-content="Lorem Ipsum"><img
                    ...
                    <div class="col-md-12 text-center">
                        <a class="btn btn-default btn-lg btn-block modal-trigger-margin" data-toggle="modal"
                           data-target="#my-floor"><i
                                class="glyphicon glyphicon-th-large pull-left"></i> View floor plan</a>
                        <a class="btn btn-default btn-lg btn-block modal-trigger-margin" data-toggle="modal"
                           data-target="#my-rating"><i
                                class="glyphicon glyphicon-align-left pull-left"></i> View EPC Document</a>
                        <a class="btn btn-default btn-lg btn-block modal-trigger-margin" data-toggle="modal"
                           data-target="#my-map"><i
                        ...
                        <a class="btn btn-normal btn-lg modal-trigger-margin" data-toggle="modal"
                           data-target="#my-request-view">Request Viewing</a><br/>
...
<div class="modal fade" id="my-floor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close modal-dismis" data-dismiss="modal"><span
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="embed-responsive embed-responsive-4by3">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3024.1769117936906!2d-74.00518579574023!3d40.71412181919358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x660aeef42acf9b9b!2sNew+York+City+Supreme+Court!5e0!3m2!1sen!2s!4v1411850450279"
